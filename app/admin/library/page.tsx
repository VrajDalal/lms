            ...
            <div className="flex flex-col pl-20 md:pl-24 pt-10 min-h-screen lg:pl-64 pr-4 lg:pr-16 bg-[#FCFAF5]">
                ...
                <div className='text-xl mt-4 flex flex-col md:flex-row md:items-center md:space-x-4'>
                    ...
                    <Popover>
                        ...
                        <PopoverContent className='duration-2000 transition-opacity transform-gpu scale-95'>
                            <div className='cursor-pointer flex items-center lg:mr-[10px]'>
                                <label htmlFor="fileupload" className='cursor-pointer flex'>
                                    Upload Excel File:

                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 24 24"
                                        className='w-16 h-16 md:w-14 md:h-14 lg:w-16 lg:h-16 flex'
                                        color="#7ed321"
                                        fill="none"
                                    >
