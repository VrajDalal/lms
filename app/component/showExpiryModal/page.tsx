...
const ShowExpiryModal: React.FC<ShowExpiryModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      <div className="fixed inset-0 text-xl bg-black bg-opacity-50 flex justify-center items-center">
