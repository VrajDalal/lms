...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        const mailOption = {
            ...
            to: studentEmail,
            subject: `Book Issue Renewal Confirmation From Library`,
            html: `
        ...
        return NextResponse.json({ success: true, message: 'Mail sent successfully to the student regarding the renewal of book' }, { status: 200 })
    } catch (error) {
